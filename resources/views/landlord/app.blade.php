...
<head>
    ...
    @include('landlord.components.styles')
    <livewire:styles />
    @yield('after_styles')
...
<body class="ltr main-body app sidebar-mini">
    ...
    <div class="page" style="background-color: #ffffff; ">
        ...
        <div>
            @include('landlord.components.app-header')

            @include('landlord.components.app-sidebar')
        ...
        @include('landlord.components.sidebar-right')

        @include('landlord.components.modal')


        @yield('modal')

        @include('landlord.components.footer')

    </div>
    <!-- End Page -->

    @include('landlord.components.scripts')
    @include('landlord.components.toastr')
