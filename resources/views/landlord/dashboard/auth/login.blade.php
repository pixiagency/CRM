                ...
                <div
                    ...
                    <div class="card-sigin mt-5 mt-md-0">
                        ...
                        <div class="main-card-signin d-md-flex">
                            <div class="wd-100p">
                                <div class="d-flex mb-4"><a href="{{route('landlord.home')}}"><img
                                ...
                                <div class="">
                                    <div class="main-signup-header">
                                            ...
                                            <div class="panel-body tabs-menu-body border-0 p-3">
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="tab5">
                                                        <form action="{{route('landlord.signin')}}" method="post">
                                        ...
                                        <div class="main-signin-footer text-center mt-3">
                                            <p><a href="{{route('landlord.signup')}}" class="mb-3">signup?</a></p>
                                        </div>
                                        <div class="main-signin-footer text-center mt-3">
                                            <p><a href="{{url('landlord/forgot')}}" class="mb-3">Forgot password?</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
