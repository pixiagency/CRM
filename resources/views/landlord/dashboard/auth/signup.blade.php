                            ...
                            <div class="wd-100p">
                                ...
                                <div class="">
                                    <div class="main-signup-header">
                                        ...
                                        <form action="{{route('landlord.signup')}}" method="post">
                                            ...
                                            <div class="form-group">
                                                <label>@lang('app.organization')</label>
                                                <input class="form-control" name="organization"
                                                    placeholder="@lang('app.organization')" type="text">
                                                @error('organization')
                                                <div class="text-danger fw-bold">{{$message}}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="main-signup-footer mt-3 text-center">
                                            <p>Already have an account? <a href="{{route('landlord.login')}}">Sign
                                                    In</a></p>
                                        </div>
                                    </div>
                                </div>
