							...
							{{-- <div class="d-flex align-items-center item  border-bottom my-2">--}}
								...
								{{-- <div class="ms-auto my-auto">--}}
									{{-- <div class="d-flex">--}}
										...
										{{-- <span class="text-success fs-13 my-auto"><i
												class="fe fe-trending-up text-success me-2 ms-1 my-auto"></i>12.75%</span>--}}
										{{-- </div>--}}
									{{-- </div>--}}
								{{-- </div>--}}
							{{-- <div class="d-flex align-items-center item  border-bottom my-2">--}}
								...
								{{-- <div class="ms-auto my-auto">--}}
									{{-- <div class="d-flex">--}}
										...
										{{-- <span class="text-success"><i
												class="fe fe-trending-down text-danger me-2 ms-1 my-auto"></i>24.37%</span>--}}
										{{-- </div>--}}
									{{-- </div>--}}
								{{-- </div>--}}
							{{-- <div class="d-flex align-items-center item  border-bottom my-2">--}}
								...
								{{-- <div class="ms-auto my-auto">--}}
									{{-- <div class="d-flex">--}}
										...
										{{-- <span class="text-success"><i
												class="fe fe-trending-up text-success me-2 ms-1 my-auto"></i>15,63%</span>--}}
										{{-- </div>--}}
									{{-- </div>--}}
								{{-- </div>--}}
							{{-- <div class="d-flex align-items-center item  border-bottom my-2">--}}
								...
								{{-- <div class="ms-auto my-auto">--}}
									{{-- <div class="d-flex">--}}
										...
										{{-- <span class="text-danger"><i
												class="fe fe-trending-up text-success me-2 ms-1 my-auto"></i>12.54%</span>--}}
										{{-- </div>--}}
									{{-- </div>--}}
								{{-- </div>--}}
							{{-- <div class="d-flex align-items-center item my-2">--}}
								...
								{{-- <div class="ms-auto my-auto">--}}
									{{-- <div class="d-flex">--}}
										...
										{{-- <span class="text-danger"><i
												class="fe fe-trending-down text-danger me-2 ms-1 my-auto"></i>15.12%</span>--}}
										{{-- </div>--}}
									{{-- </div>--}}
								{{-- </div>--}}
							{{-- </div>--}}
